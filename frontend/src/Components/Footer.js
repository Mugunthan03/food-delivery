    ...
    <div className='bg-[#323232] mt-5 ' id="footer">
       <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-9 md:gap-20 mx-9 md:mx-20 lg:mx-36 pt-10 pb-10 '>
        <div className='w-[90%] flex flex-col items-start gap-5'>
            ...
            <p className='text-gray-400 text-sm xl:text-lg'>Step into a realm of culinary delight where every dish tells a story of craftsmanship and flavor. Join us for an unforgettable dining experience, where passion meets perfection.</p>
        ...
        <div className='flex flex-col items-start gap-3'>
            ...
            <p  className='text-gray-400 text-sm xl:text-lg'>contacttakeaway@gmail.com</p>
       ...
       <div className='pb-10 pt-5'>
        <h1 className='text-center text-gray-400 text-sm xl:text-lg '>copyrights 2024 &copy; takeaway.com. All rights reserved</h1>
       </div>
    </div>
  )
}
